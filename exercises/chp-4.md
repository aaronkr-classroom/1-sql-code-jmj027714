...
**06 다음 관계 대수 연산 중 관계 연산에 해당하는 것은?** [1]
...
2. 관계 대수는 수학 집합 이론에 기반을 둔 (집합론적) 연산 그룹과 관계형 데이터 모델을 위해 추가된 (관계연산) 연산 그룹 2 개의 그룹으로 분류한다.
...
11. 작성된 후보 관계 대수식은 DBMS 안의 질의 최적화 과정을 위해 내부적으로 (질의 리)로 변환되어 표현된다.
...
π(학번,이름)(학생⋈π(학번)(σ(과목명= ′ 데이터베이스 ′ )(수강)))
